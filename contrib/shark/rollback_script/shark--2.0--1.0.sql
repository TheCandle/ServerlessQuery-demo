...
drop function is exists sys.isnull(text,smallint);
drop function is exists sys.isnull(text,integer);
drop function is exists sys.isnull(text,bigint);
drop function is exists sys.isnull(text,real);
drop function is exists sys.isnull(text,double precision);
drop function is exists sys.isnull(text,numeric);
