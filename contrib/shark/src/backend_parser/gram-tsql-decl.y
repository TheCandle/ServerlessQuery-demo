...
%token <keyword> CATCH CHECKIDENT DBCC NO_INFOMSGS NORESEED RESEED SAVE TRAN TRY TSQL_CLUSTERED TSQL_NONCLUSTERED TSQL_COLUMNSTORE
...
%token <keyword> TSQL_TRY_CAST TSQL_TRY_CONVERT TSQL_CONVERT TSQL_DATEDIFF TSQL_DATEDIFF_BIG
    ...
    TSQL_W TSQL_Y TSQL_S TSQL_YYYY TSQL_YY TSQL_DD TSQL_NANOSECOND TSQL_CAST
