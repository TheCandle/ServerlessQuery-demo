...
function(GET_VERSIONSTR_FROMGIT ret)
    ...
    execute_process(COMMAND getconf LONG_BIT OUTPUT_VARIABLE bit OUTPUT_STRIP_TRAILING_WHITESPACE)
    execute_process(
        COMMAND ${CMAKE_SOURCE_DIR}/${openGauss}/cmake/src/buildfunction.sh --s ${PROJECT_TRUNK_DIR} OUTPUT_VARIABLE GS_VERSION_STR)
    set(GS_VERSION_STR "${GS_VERSION_STR} on ${host}, compiled by ${cc_string}, ${bit}-bit")
    ...
    if(NOT ${ENABLE_MULTIPLE_NODES} STREQUAL OFF)
