...
extern const uint32 INSERT_INTO_SELECT_VERSION_NUM;
...
#define OPT_BIND_SCHEMA_TABLESPACE (1LL << 3)
#define OPT_RETURN_NS_OR_NULL (1LL << 4)
#define OPT_BIND_SEARCHPATH (1LL << 5)
#define OPT_UNBIND_DIVIDE_BOUND (1LL << 6)
#define OPT_CORRECT_TO_NUMBER (1LL << 7)
#define OPT_CONCAT_VARIADIC (1LL << 8)
#define OPT_MERGE_UPDATE_MULTI (1LL << 9)
#define OPT_CONVERT_TO_NUMERIC (1LL << 10)
#define OPT_PLSTMT_IMPLICIT_SAVEPOINT (1LL << 11)
#define OPT_HIDE_TAILING_ZERO (1LL << 12)
#define OPT_SECURITY_DEFINER (1LL << 13)
#define OPT_SKIP_GS_SOURCE (1LL << 14)
#define OPT_PROC_OUTPARAM_OVERRIDE (1LL << 15)
#define OPT_ALLOW_PROCEDURE_COMPILE_CHECK (1LL << 16)
#define OPT_IMPLICIT_FOR_LOOP_VARIABLE (1LL << 17)
#define OPT_AFORMAT_NULL_TEST (1LL << 18)
#define OPT_AFORMAT_REGEX_MATCH (1LL << 19)
#define OPT_ROWNUM_TYPE_COMPAT (1LL << 20)
#define OPT_COMPAT_CURSOR (1LL << 21)
#define OPT_CHAR_COERCE_COMPAT (1LL << 22)
#define OPT_PGFORMAT_SUBSTR (1LL << 23)
#define OPT_TRUNC_NUMERIC_TAIL_ZERO (1LL << 24)
#define OPT_ALLOW_ORDERBY_UNDISTINCT_COLUMN (1LL << 25)
#define OPT_SELECT_INTO_RETURN_NULL (1LL << 26)
#define OPT_ACCEPT_EMPTY_STR (1LL << 27)
#define OPT_PLPGSQL_DEPENDENCY (1LL << 28)
