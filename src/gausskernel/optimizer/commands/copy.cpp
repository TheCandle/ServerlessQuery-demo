                ...
                if (useHeapMultiInsert) {
                    ...
                    if (isPartitionRel) {
                        if (RelationIsSubPartitioned(resultRelationDesc)) {
                            targetOid = heapTupleGetSubPartitionOid(resultRelationDesc, tuple, estate, slot);
                        } else {
                    ...
                    if (isPartitionRel && needflush) {
                        ...
                        if (RelationIsSubPartitioned(resultRelationDesc)) {
                            targetPartOid = heapTupleGetSubPartitionOid(resultRelationDesc, tuple, estate, slot);
                        } else {
