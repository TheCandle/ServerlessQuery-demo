...
LOAD DATA LOCAL INPATH '$CONTAINER_DATA_DIR/region.csv' OVERWRITE INTO TABLE region_text;
LOAD DATA LOCAL INPATH '$CONTAINER_DATA_DIR/nation.csv' OVERWRITE INTO TABLE nation_text;
LOAD DATA LOCAL INPATH '$CONTAINER_DATA_DIR/customer.csv' OVERWRITE INTO TABLE customer_text;
LOAD DATA LOCAL INPATH '$CONTAINER_DATA_DIR/supplier.csv' OVERWRITE INTO TABLE supplier_text;
LOAD DATA LOCAL INPATH '$CONTAINER_DATA_DIR/part.csv' OVERWRITE INTO TABLE part_text;
LOAD DATA LOCAL INPATH '$CONTAINER_DATA_DIR/partsupp.csv' OVERWRITE INTO TABLE partsupp_text;
LOAD DATA LOCAL INPATH '$CONTAINER_DATA_DIR/orders.csv' OVERWRITE INTO TABLE orders_text;
LOAD DATA LOCAL INPATH '$CONTAINER_DATA_DIR/lineitem.csv' OVERWRITE INTO TABLE lineitem_text;
EOF
